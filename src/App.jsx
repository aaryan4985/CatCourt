...
const Courtroom = () => {
  ...
  return (
    <motion.div animate={controls} className="h-screen bg-pop-yellow relative overflow-hidden flex flex-col items-center pt-2 px-4">
      ...
      <Sticker x="5%" y="10%" rotate={-10}><Scale size={80} className="text-black opacity-20" /></Sticker>
